...
preguntas = [
    ...
    ("¿Qué super poder te gustaría tener?", ["Dormir.", "Invisibilidad.", "Superfuerza.", "Teletransportación."]),
]

# Diccionario de respuestas asociadas con cada casa.
casas = {
    "Gryffindor": ["Valiente.", "Te extraña, pero sonríe.", "Gloria.", "La fuerza.","Invisibilidad."],
    "Slytherin": ["Ambicioso.", "Pide más historias sobre tus aventuras.", "Sabiduría.", "La astucia.","Dormir."],
    "Hufflepuff": ["Leal.", "Piensa con admiración tus logros.", "Amor.", "La paciencia.","Superfuerza."],
    "Ravenclaw": ["Curioso.",
                  "No me importa lo que piensen de mí después de mi muerte, lo que piensen de mí ahora es lo que cuenta.",
                  "Poder.", "La inteligencia.","Teletransportación."]
}
